...
<Tip>
  Long breaks can be configured or disabled in the [configuration file](/configuration/session-settings). The default is a 15-minute break after 4 work sessions.
</Tip>
